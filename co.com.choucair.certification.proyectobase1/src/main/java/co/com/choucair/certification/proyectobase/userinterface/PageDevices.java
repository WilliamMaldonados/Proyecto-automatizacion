...
public class PageDevices {
    ...
    public static final Target CONTAINER_OS = Target.the("CONTAINER OS")
    ...
    public static final Target BOTTON_FN =Target.the("BOTON FINAL")
